...
public class AllDataSyncRequestJob extends BaseJob {
  ...
  public void onRun() throws IOException, UntrustedIdentityException {
    ...
    signalServiceMessageSender.sendSyncMessage(SignalServiceSyncMessage.forRequest(RequestMessage.forType(SignalServiceProtos.SyncMessage.Request.Type.PNI_IDENTITY)), accessForSync);
  }
  ...
  public static final class Factory implements Job.Factory<AllDataSyncRequestJob> {
    @Override
    public @NonNull AllDataSyncRequestJob create(@NonNull Parameters parameters, @NonNull Data data) {
